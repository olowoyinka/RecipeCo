...
urlpatterns = [
    ...
    path(
        "chef/recipe/<str:recipe_id>",
        recipeView.GetRecipeById,
        name="get_recipe_Id",
    ),
    path(
    ...
    path(
        "chef/recipe/edit/<str:recipe_id>",
    ...
    path(
        "favorite/chef",
        userRecipeView.GetRegularUserFavorite,
        name="get_chef_favorite",
    ),
    path(
    ...
    path(
        ...
        userRecipeView.GetRecipeById,
        name="user_recipe_id",
    ),
    path(
        "favorite/recipe",
        userRecipeView.GetRecipeFavorite,
        name="get_recipe_favorite",
    ),
    path(
    ...
    path(
        "chef/search/<str:search>",
        userRecipeView.ChefResult,
        name="user_chef_search",
    ),
    path(
